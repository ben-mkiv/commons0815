...
public class GuiUtil {
    ...
    public static void drawGradientRect(int posX, int posY, int width, int height, int zLevel, int c1, int c2){
        ...
        vertexbuffer.pos((double)width, (double)posY, (double)zLevel).color(f1, f2, f3, f).endVertex();
        vertexbuffer.pos((double)posX, (double)posY, (double)zLevel).color(f1, f2, f3, f).endVertex();

        vertexbuffer.pos((double)posX, (double)height, (double)zLevel).color(f5, f6, f7, f4).endVertex();
        vertexbuffer.pos((double)width, (double)height, (double)zLevel).color(f5, f6, f7, f4).endVertex();
