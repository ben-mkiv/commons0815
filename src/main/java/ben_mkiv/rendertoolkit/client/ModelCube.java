...
public class ModelCube {
    ...
    private static int renderMode = GL11.GL_QUADS;
    ...
    public ModelCube(AxisAlignedBB aabb, float grow){
        this((float) aabb.minX - grow, (float) aabb.minY - grow, (float) aabb.minZ - grow, (float) aabb.maxX + grow, (float) aabb.maxY + grow, (float) aabb.maxZ + grow);
    }

    public void setP1(float x, float y, float z){
        p1 = new Vector3f(x, y, z);
    }

    public void setP2(float x, float y, float z){
        p2 = new Vector3f(x, y, z);
    }
    ...
    public void drawCube(int renderMode){
        ModelCube.renderMode = renderMode;
        drawCube();
        ModelCube.renderMode = GL11.GL_QUADS;
    }
    ...
    public static void drawTop(float x1, float y1, float z1, float x2, float y2, float z2){
        GlStateManager.glBegin(renderMode);
    ...
    public static void drawAABB(AxisAlignedBB aabb, float grow){
        drawCube((float) aabb.minX - grow, (float) aabb.minY - grow, (float) aabb.minZ - grow, (float) aabb.maxX + grow, (float) aabb.maxY + grow, (float) aabb.maxZ + grow);
    }
}
