package ben_mkiv.commons0815.chickenbones;
...
public class Matrix4
{
    ...
    public DoubleBuffer asDoubleBuffer(){
        DoubleBuffer buf = BufferUtils.createDoubleBuffer(2* 16);
        buf.put(m00);
        buf.put(m10);
        buf.put(m20);
        buf.put(m30);
    ...
    public Vec3d[] store3f() {
        return new Vec3d[] { store3f(0), store3f(1), store3f(2) };
    }

    public Vec3d store3f(int axis) {
        switch(axis){
            case 2:
    ...
    public Matrix4 translate(Vec3d vec){ return this.translate(vec.x, vec.y, vec.z); }
